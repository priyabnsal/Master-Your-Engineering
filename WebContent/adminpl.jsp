...
<h3 class="text-center text-capitalize">C language</h3>
<div class="container">
  <form action="adminpl.jsp" method="post">
    <div class="row">
      <div class="col-25">
        <label for="fname">Id</label>
      </div>
      <div class="col-75">
        <input type="text" id="fname" name="firstname" placeholder=" Enter ID">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
	...
	<%
	DBHandlerpl objD=new DBHandlerpl();
	LinkedList<Clspl> lst=objD.getadminpl();
	%>
        ...
        <div class="modal-body">
        	<div class="">
				<div class="row">
					...
					<div class="col-md-6">
						 <form action="deletepl.jsp" method="post"> 
							<table class="table table-bordered table-dark table-hover table-sm">
								...
								for(Clspl objh:lst)
								{
									...
									<td><input type="checkbox" name ="chb" value="<%=objh.getStrid()%>"/></td>
									</tr>
								<%
								}%>
							</table>
...
<%
plDBHandler objDH=new plDBHandler();
...
objDH.InsertIntoadminpl(strid,strlink);

  }
/*  else if(strBtn.equals("Delete Values"))
{
