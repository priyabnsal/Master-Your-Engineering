...
<li class="nav-item">
<a class="nav-link" href="#" tabindex="-1" aria-disabled="true"><i class="priya">Our Team</i></a>
</li>
...
<ul class="nav nav-tabs mx-auto my-auto ">
  ...
  <li class="nav-item">
    <a class="nav-link" href="youtube3.jsp">3rd year<superscript></superscript></a>
  </li>
  <li class="nav-item">
...
<h3 class="text-center text-capitalize pt-5">MATHEMATICS-1</h3>
<div class="row mx-auto py-5">
<div class="col-lg-4 col-md-6 col-12 mb-4">
      <iframe width="360" height="215" src="https://www.youtube.com/embed/ycfzucO0zEk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
<div class="col-lg-4 col-md-6 col-12 mb-4">
     
      <iframe width="360" height="215" src="https://www.youtube.com/embed/yzIB9Ytf_gk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
<div class="col-lg-4 col-md-6 col-12 mb-4">
     
      <iframe width="360" height="215" src="https://www.youtube.com/embed/_BVsw0r1tQM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
     </div>
    </div>
<!-- <h2 class="text-center text-capitalize pt-5">Our Services</h2> -->
<h3 class="text-center text-capitalize pt-5">MATHEMATICS-2</h3>
<div class="row mx-auto py-5">
<div class="col-lg-4 col-md-6 col-12 mb-4">
     <iframe width="360" height="215" src="https://www.youtube.com/embed/6pcLfhKRCKQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     </div>
 <div class="col-lg-4 col-md-6 col-12 mb-4">
     <iframe width="360" height="215" src="https://www.youtube.com/embed/FGuX3QCVzy0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</div>
<!-- <h1 class="text-center text-capitalize pt-5">Our Services</h1> -->
<h3 class="text-center text-capitalize pt-5">EGD</h3>
<div class="row mx-auto py-5">
<div class="col-lg-4 col-md-6 col-12 mb-4">
  <iframe width="360" height="215" src="https://www.youtube.com/embed/G3DJ4pu1qF4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>  
   </div>
      <div class="col-lg-4 col-md-6 col-12 mb-4">
      <iframe width="360" height="215" src="https://www.youtube.com/embed/uojN7SOHPBw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
