...
<link rel="stylesheet" href="clang.css">
...
<section id="contact">
<p>Java Language Tutorials</p>
</section>

<!-------------------------------------------Videos----------------------->
<section id="youtube" class="container ">
<h3 class="text-center text-capitalize pt-5"></h3>
<%
JavaDBHandler objDH=new JavaDBHandler();
LinkedList<Clsjava> lst=objDH.getadminjava();
%>
