...
<p>Master Your Engineering is a portal for students who choose engineering stream especially computer science and engineering which allows students get right guidance for there future.
</p>
...
<a class="nav-link " href="index.jsp"><i class="priya">Home</i> <span class="sr-only">(current)</span></a>
</li>
<li class="nav-item">
...
<!-- <div class="follow"><b>Address: </b><i class="fa fa-map-marker"></i>Model Town, Panipat</div> -->
<!-- <div class="follow"><b>Phone: </b><i class="fa fa-phone"></i>9991879761</div> -->
<!-- <div class="follow"><b>E-mail: </b><i class="fa fa-envelope"></i>yourengineering.4@gmail.com</div> -->
<!-- <div class="follow"><label><b>Get Social: </b></label><a href="#"><i class="fab fa-facebook"></i></a> -->
