...
<%@page import="icsd.booksDBHandler"%>
...
<nav class="navbar navbar-light bg-light">
  ...
  <li class="nav-item my-2">
     <a href="frontadmin.jsp" class="nav-link "><i class="fa fa-fw fa-home"></i> Home</a>
     
    </li>
    <li class="nav-item my-2">
      <a href="admin.jsp" class="nav-link active"><i class="fa fa-fw fa-home"></i> E-Books</a>
...
<h3 class="text-center text-capitalize">E-Books</h3>
<div class="container">
  <form action="admin.jsp" method="post">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="firstname" placeholder=" Book ID">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="bookname" placeholder=" Book Name">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
	...
	<%
	DBHandlerEbooks objD=new DBHandlerEbooks();
	LinkedList<ClsEbooks> lst=objD.getadmin();
	%>
        ...
        <div class="modal-body">
        	<div class="">
				<div class="row">
					...
					<div class="col-md-6">
						<form action="deleteebooks.jsp" method="post">
							<table class="table table-bordered table-dark table-hover table-sm">
								...
								<%
								for(ClsEbooks objh:lst)
								{
									%>
									<tr>
									<td><%=objh.getStrbookid()%></td>
									<td><%=objh.getStrbookname()%></td>
									<td><%=objh.getStrimage()%></td>
									<td><%=objh.getStrlink() %></td>
									
									<td><input type="checkbox" name ="chb" value="<%=objh.getStrbookid()%>"/></td>
									</tr>
								<%
								}%>
							</table>
...
strbookid=request.getParameter("firstname");
strbookname=request.getParameter("bookname");
strimage=request.getParameter("image");
strlink=request.getParameter("link");


objDH.InsertIntoadminbooks(strbookid,strbookname,strimage,strlink);
