...
<ul class="nav nav-tabs mx-auto my-auto ">
  ...
  <li class="nav-item">
    <a class="nav-link " href="youtube3.jsp">3rd year<superscript>th</superscript></a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="#">2nd year</a>
  </li>
...
<h3 class="text-center text-capitalize pt-5">OOPS</h3>
<div class="row mx-auto py-5">

      <div class="col-lg-4 col-md-6 col-12 mb-4">
      <iframe width="360" height="215" src="https://www.youtube.com/embed/Q_GpaMhc-dU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
     
<div class="col-lg-4 col-md-6 col-12 mb-4">    
 <iframe width="360" height="215" src="https://www.youtube.com/embed/5ilkmV1jNuA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
 </div>
<div class="col-lg-4 col-md-6 col-12 mb-4">  
  <iframe width="360" height="215" src="https://www.youtube.com/embed/4Y0N43i2RNs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
   
       
    </div>
<h3 class="text-center text-capitalize pt-5">OS</h3>
<div class="row mx-auto py-5">

 <div class="col-lg-4 col-md-6 col-12 mb-4">
<iframe width="360" height="215" src="https://www.youtube.com/embed/BNULDyOEyp8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
 <div class="col-lg-4 col-md-6 col-12 mb-4">    
    <iframe width="360" height="215" src="https://www.youtube.com/embed/YwqexcfbucE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
       </div>
    </div>
<h3 class="text-center text-capitalize pt-5">DS</h3>
<div class="row mx-auto py-5">

      <div class="col-lg-4 col-md-6 col-12 mb-4">
      <iframe width="360" height="215" src="https://www.youtube.com/embed/aGjL7YXI31Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      <div class="col-lg-4 col-md-6 col-12 mb-4">
      <iframe width="360" height="215" src="https://www.youtube.com/embed/q2FpkqnTPjI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    <div class="col-lg-4 col-md-6 col-12 mb-4">
<iframe width="360" height="215" src="https://www.youtube.com/embed/BNULDyOEyp8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
       </div>
